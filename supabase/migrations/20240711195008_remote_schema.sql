...
ALTER TABLE "public"."projects"
    ...
    ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
        "public"."projects_id_seq" START WITH 1 INCREMENT BY 1
        NO MINVALUE
        NO MAXVALUE
        CACHE 1);
...
ALTER TABLE "transactions"."transactions"
    ALTER COLUMN "id"
    ADD GENERATED BY DEFAULT AS IDENTITY (SEQUENCE NAME
        "transactions"."transactions_id_seq" START WITH 1 INCREMENT BY 1
        NO MINVALUE
        NO MAXVALUE
        CACHE 1);
...
CREATE POLICY "Users can only read their own projects" ON "public"."projects"
    FOR SELECT
...
GRANT ALL ON SEQUENCE "public"."projects_id_seq"
    TO "anon";
