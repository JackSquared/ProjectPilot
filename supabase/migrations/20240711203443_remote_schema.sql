...
CREATE TABLE IF NOT EXISTS "public"."projects" (
    ...
    "server_tags" character varying[],
    "client_tags" character varying[],
    "ops_tags" character varying[],
    "storage_tags" character varying[],
...
ALTER TABLE "transactions"."transactions" OWNER TO "postgres";

COMMENT ON TABLE "transactions"."transactions" IS 'pro users';

ALTER TABLE "transactions"."transactions" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE POLICY "Enable insert for users based on user_id" ON "public"."projects" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));

CREATE POLICY "Users can only read their own projects" ON "public"."projects" FOR SELECT USING (("auth"."uid"() = "user_id"));
